<x-app-layout>
    ...
    <div class="flex items-center justify-between w-full">
        <div>
            ...
            <p class="hidden lg:block text-sm text-gray-500 mt-1">Pantau sertifikat yang masa berlakunya akan segera habis.</p>
        </div>
    </div>
</x-slot>
