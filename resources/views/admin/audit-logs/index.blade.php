<x-app-layout>
    ...
    <div class="flex items-center justify-between w-full">
        <div>
            <h2 class="text-2xl font-bold tracking-tight text-gray-900">Audit Trail</h2>
            <p class="hidden lg:block text-sm text-gray-500 mt-1">Review chronological records of system activities.</p>
        </div>
    </div>
</x-slot>
