    ...
    <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-sidebar-900 border-r border-sidebar-800 px-6 pb-4">
        ...
        <nav class="flex flex-1 flex-col">
            <ul role="list" class="flex flex-1 flex-col gap-y-7">
                <li>
                    <div class="text-xs font-semibold leading-6 text-gray-500 uppercase tracking-wider mb-2">Main Menu</div>
                ...
                <li>
                    <div class="text-xs font-semibold leading-6 text-gray-500 uppercase tracking-wider mb-2">Administration</div>
                    <ul role="list" class="-mx-2 space-y-1">
                        <li>
