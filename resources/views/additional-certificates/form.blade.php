...
<div class="grid gap-4 md:grid-cols-2">
    ...
    <label class="text-sm">Kedaluwarsa<input type="date" name="expired_date" value="{{ old('expired_date', $additionalCertificate?->expired_date?->format('Y-m-d')) }}" class="mt-1 w-full rounded-md border-gray-300 text-sm"></label>
