<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between w-full">
            <div>
                <h2 class="text-2xl font-bold tracking-tight text-gray-900">Documents</h2>
                <p class="hidden lg:block text-sm text-gray-500 mt-1">Repository for all property-related files.</p>
            </div>
            @can('upload_document')
